...
\begin{frame}[fragile]
	...
	\begin{outputbox}
		\begin{figure}
			\centering
			\includegraphics[width=0.3\textwidth]{loewenjagd}
		\end{figure}
	\end{outputbox}
...
\begin{frame}[fragile]
	...
	\begin{outputbox}
		...
		\begin{figure}[H]
			\centering
			\includegraphics[width=0.2\textwidth]{loewenjagd.png}
		\end{figure}
		\vspace{-0.2cm}
	\end{outputbox}
...
\subsection{Sonstige Methoden}
	\subsubsection{Diktatorische Methode}
		...
		\begin{figure}
			\centering
			\includegraphics[]{loewenjagd.png}
		\end{figure}
	\end{lstlisting}
\end{frame}
%%-----------------------------------------------------------------------------------------------%
...
\includegraphics[width=0.4\textwidth]{meinbild.jpg}
	...
	\begin{outputbox}
		\begin{figure}[H]
			\centering
			\includegraphics[width=0.5\textwidth]{loewenjagd.png}
		\end{figure}
	\end{outputbox}
\end{frame}
%-----------------------------------------------------------------------------------%
...
\begin{frame}[fragile]
	...
	\begin{outputbox}
		...
		\begin{figure}
			\centering
			\includegraphics[width=0.1\textwidth]{loewenjagd.png}
		\end{figure}
		\begin{center}
