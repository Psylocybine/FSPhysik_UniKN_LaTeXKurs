...
\begin{frame}[fragile]
	\Aufgabee
		...
		\textrm{\qquote{Diktatorische Methode}}
		
		als \lstinline[basicstyle=\normalfont\ttfamily\normalsize]|\subsubsection| der Section \qquote{Sonstige Methoden} ein und schreibe folgenden Text:
...
\begin{frame}[fragile]
	\Code*
		\begin{lstlisting}[gobble=12]
			\begin{figure}
				\centering
				\includegraphics[width=0.3\textwidth]{img/loewenjagd.png}
				\caption{Löwenjagd zur heutigen Zeit.}
			\end{figure}
		\end{lstlisting}
	\Ausgabe
		\begin{outputbox}
